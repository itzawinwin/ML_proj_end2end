...
import os
from src.ultils import save_object
...
class DataTranformation:
    ...
    def  get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Numerical columns standard scaling configured for: {numerical_columns}")
            logging.info(f"Categorical columns encoding configured for: {categorical_columns}")
